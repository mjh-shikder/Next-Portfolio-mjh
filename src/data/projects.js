export const demoProjects = [
    ...
    {
        id: "2",
        title: "Paw Mart A Community Driven Platform for Pet Lovers",
        tech: ["React", "React-Router", "Axios", "Tailwind CSS", "Firebase"],
        shortDesc: "A community driven platform for pet lovers.",
        description: "This project is a community driven platform for pet lovers. It is a full-stack application that allows users to register as pet lovers or request pet products and services. It also has a feature that allows users to search for pet products and services based on their location.",
        image: "/images/pawmart.png",
        liveLink: "https://mjhpawmart.netlify.app/",
        githubLink: "https://github.com/mjh-shikder/A-10-PawMart-Web-App-Clint",
        challenges: "The main challenge was to create a user-friendly interface that could be used by people of all ages. I also had to make sure that the website was responsive and could be used on different devices. Additionally, I had to make sure that the website was secure and that the data was protected.",
        futurePlans: "Want to add more features like user authentication, pet bank integration, and a mobile app."
    },
    {
        id: "3",
        title: "Toy Kingdom",
