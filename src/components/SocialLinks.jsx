import { Github, Linkedin, Twitter, Facebook, X, Instagram } from "lucide-react";

export default function SocialLinks() {
  const socialLinks = [
    { name: "GitHub", icon: Github, href: "https://github.com/mjh-shikder", color: "hover:text-gray-300" },
    { name: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/in/mjh-shikder/", color: "hover:text-blue-500" },
    { name: "Twitter", icon: X, href: "https://x.com/mjh_shikder", color: "hover:text-cyan-400" },
    { name: "Facebook", icon: Facebook, href: "https://www.facebook.com/mjhshikder/", color: "hover:text-blue-600" },
    { name: "Instagram", icon: Instagram, href: "https://www.instagram.com/mjh_shikder/", color: "hover:text-pink-600" },
    { 
      name: "Fiverr", 
      icon: () => (
      ...
      href: "https://www.fiverr.com/mjh_shikder", 
